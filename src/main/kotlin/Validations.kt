...
fun validateDocumentName(name: String) {
    if(name.isBlank() || specialCharactersRegexForDocument.containsMatchIn(name))
        throw InvalidNameException("Please introduce a valid name for the document.")
}
