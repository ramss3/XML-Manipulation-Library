...
class TestAnnotations {
    ...
    fun testChangeName() {
        ...
        assertEquals(Attribute("nome", "Quizzes", xmlEntity), xmlEntity.findAttribute("nome"))
    }
    ...
    fun testExclusion() {
        ...
        val xmlEntity = XmlConverter.toXml(f)
        assertEquals(Attribute("codigo", "M4310", xmlEntity), xmlEntity.findAttribute("codigo"))
    ...
    fun testStringTransformer() {
        val c = ComponenteAvaliacao("Quizzes", "20")
        val xmlEntity = XmlConverter.toXml(c)
        assertEquals(Attribute("peso", "20%", xmlEntity), xmlEntity.findAttribute("peso"))
    }
