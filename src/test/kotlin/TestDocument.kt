...
class TestDocument {
    ...
    fun testAddAttributeGlobal() {
        ...
        assertEquals(Attribute("name", "Mestrado em Engenharia Informática", diretorio2), diretorio2.findAttribute("name"))
        ...
        val exception3 = assertThrows<InvalidNameException> {
            document.addAttribute("avaliacao", "nome", "")
        }
    ...
    fun testRenameAttributeGlobal() {
        ...
        assertEquals(Attribute("nome","Mestrado em Engenharia Informática",diretorio2), diretorio2.findAttribute("nome"))
        assertEquals(Attribute("nota","6.0",diretorio2), diretorio2.findAttribute("nota"))
        ...
        val exception3 = assertThrows<InvalidNameException> {
            document.renameAttribute("avaliacao", "nome", "#ds")
        }
        ...
        val exception4 = assertThrows<InvalidNameException> {
            document.renameAttribute("avaliacao", "nome", "")
        }
    ...
    fun testRemoveAttributeGlobal() {
        ...
        assertEquals(null, diretorio2.findAttribute("name"))
        assertEquals(Attribute("ects", "6.0", diretorio2), diretorio2.findAttribute("ects"))
